  ...
  return (
    <>
      ...
      <div className="mt-16 grid gap-8 md:grid-cols-2 lg:gap-12">
        <div>
          <div className="animate-slide-in-left overflow-hidden rounded-lg bg-sky-50 shadow-lg">
        ...
        <div className="animate-slide-in-right md:pt-8">
          <div className='flex flex-col justify-center'>
            <p className="text-xl text-center font-bold text-cyan-600 md:text-left">What is [MSC for me]?</p>
            <h1 className="mb-4 text-center text-3xl font-semibold text-slate-700 sm:text-4xl md:mb-6 md:text-left">船内で利用できるスマホアプリ</h1>
            <ul className="space-y-4 text-left text-slate-700 mb-10">
            ...
            <p className="max-w-md leading-relaxed text-slate-700 xl:text-xl">
