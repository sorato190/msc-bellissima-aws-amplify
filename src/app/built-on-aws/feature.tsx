        ...
        <div className="mx-auto max-w-(--breakpoint-2xl) px-4 md:px-8">
          <div className="animate-slide-in-right md:pt-8">
            <div className='flex flex-col justify-center items-center'>
              <h1 className="mb-4 text-center text-3xl font-semibold text-slate-700 sm:text-4xl md:mb-6 md:text-left">AWS Amplifyの特徴</h1>
              <ul className="space-y-4 text-center text-slate-700 mb-10">
              ...
              <p className="max-w-md leading-relaxed text-left text-slate-700 xl:text-base md:text-xl">
              </p>
            </div>
          </div>
        </div>
