...
export default function TourComment() {
  ...
  return (
    <div className='mx-10'>
      <p className={inView ? "md: w-full text-slate-600 xl:text-2xl" : "md:invisible"} ref={ref}>
        ...
        それでも<Link className="text-2lg font-semibold text-blue-600 transition duration-100 hover:text-cyan-600 active:text-cyan-700" href='/facility'>船内の設備</Link>が充実しているので、各寄港地は船旅のオマケ程度というイメージで良いかも。
