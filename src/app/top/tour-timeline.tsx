      ...
      <ol className={inView ? "md:animate-slide-in-right border-l-2 border-blue-700 dark:border-primary-500" : "md:invisible"} ref={ref}>
        <li>
          ...
          <div className="mb-6 ml-6 pb-6">
            ...
            <p className="mb-4 mt-2 text-sm sm:text-base md:text-lg lg:text-xl text-gray-900">
        ...
        <li>
          <div className="flex-start flex items-center">
            <div
              className="-ml-[9px] -mt-2 mr-3 flex h-4 w-4 items-center justify-center rounded-full bg-blue-500 dark:bg-primary-500"></div>
            <h4 className="-mt-2 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-orange-500"><span className='text-black text-lg sm:text-xl md:text-2xl'>鹿児島 ⇒ </span>終日航海</h4>
          </div>
          <div className="mb-6 ml-6 pb-6">
            <div className="text-lg sm:text-xl md:text-2xl text-blue-600 transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
            >8 August, 2023
        ...
        <li>
          <div className="flex-start flex items-center">
            <div
              className="-ml-[9px] -mt-2 mr-3 flex h-4 w-4 items-center justify-center rounded-full bg-blue-500 dark:bg-primary-500"></div>
            <h4 className="-mt-2 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-orange-500"><span className='text-black text-lg sm:text-xl md:text-2xl'>高知 ⇒ </span>室蘭</h4>
          </div>
          <div className="mb-6 ml-6 pb-6">
            <div className="text-lg sm:text-xl md:text-2xl text-blue-600 transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
            >9 August, 2023
