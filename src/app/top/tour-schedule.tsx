      ...
      >
        ...
        <div className="mb-8 flex flex-wrap justify-between md:mb-16">
          ...
          <div className="mb-12 flex w-full md:mb-16 lg:w-3/4">
            {/* <div className="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-sky-50 shadow-lg md:left-16 md:top-16 lg:ml-0"> */}
            ...
            {/* <div className="overflow-hidden rounded-lg bg-sky-50 shadow-lg"> */}
            <div className="relative left-20 top-16 z-10 -ml-12 overflow-hidden rounded-lg bg-sky-50 shadow-lg md:left-16 md:top-16 lg:ml-0">
              <img
