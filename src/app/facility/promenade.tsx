    ...
    <>
      ...
      <section className="text-slate-700 body-font">
        <div className={inView ? "md:animate-tracking-in-expand mb-10 md:mb-16" : "invisible"} ref={ref}>
          <h2 className="mb-4 text-center  text-2xl font-bold text-slate-800 sm:text-3xl md:text-4xl md:mt-5 md:mb-5">Deck6 Promenade / Shopping</h2>

          <p className="mx-auto max-w-(--breakpoint-lg) text-slate-700 text-base md:text-xl">
