  ...
  return (
    <>
      ...
      <section className="text-gray-900 body-font">
        <div className={inView ? "animate-tracking-in-expand mb-10 md:mb-16" : "invisible"} ref={ref}>
          <h2 className="mb-4 text-center text-4xl font-bold text-gray-800 md:mb-6 sm:text-5xl md:mb-8 md:text-6xl">Deck:6 Promenade / Shopping</h2>

          <p className="mx-auto max-w-screen-lg text-gray-900 md:text-xl">
