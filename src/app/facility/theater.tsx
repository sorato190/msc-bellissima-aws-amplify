  ...
  return (
    <>
      ...
      <div className="h-200 grid gap-2 md:gap-6 sm:grid-cols-2">
        {/* <!-- product - start --> */}
        <div className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-sky-50 p-4 shadow-lg">
          ...
          <div className="relative flex flex-col">
            <span className="text-sky-100">London Theater</span>
          </div>
        </div>
        {/* <!-- product - end --> */}
        ...
        <div className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-sky-50 p-4 shadow-lg">
          ...
          <div className="relative flex flex-col">
            <span className="text-sky-100">Casino</span>
          </div>
        </div>
        {/* <!-- product - end --> */}
      </div>
