    ...
    <>
      ...
      <div className="mt-16 mb-10 md:mb-16">
        ...
        <div className={inView ? "md:animate-slide-top" : "invisible"} ref={ref}>
          <p className="mx-auto max-w-(--breakpoint-lg) text-gray-900 text-base md:text-xl">デッキの前方に無料で見れるロンドンシアター、デッキ後方に有料で見れるカルーセルラウンジのシアターがある。日替わりでショーやバンドの演奏などが行われている。<br />
